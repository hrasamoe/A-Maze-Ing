...
The reusable part of our code consists of the packages generated by the `make build` command such as:
  + **mazegen-1.0.0-py3-none-any.whl**
  + **mazegen-1.0.0.tar.gz**

**How to use it:**
  + **mazegen-1.0.0-py3-none-any.whl**:
    + Copy this package to a folder
    + create a main.py file and a config.txt file
    + install the package via a package manager (pip, poetry, ...)
    + importer mazegen into main.py
  ...
  + **mazegen-1.0.0.tar.gz:**
    + Extract the file
    + import this file into main as described above
